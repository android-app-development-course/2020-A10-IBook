...
import com.example.ceproject1.db.BookMarks;
import com.example.ceproject1.dialog.PageModeDialog;
import com.example.ceproject1.dialog.SettingDialog;
import com.example.ceproject1.util.BrightnessUtil;
import com.example.ceproject1.util.PageFactory;
import com.example.ceproject1.util.SpeechUtil;
import com.example.ceproject1.view.PageWidget;
...
//    LinearLayout ll_top;
    ...
    protected void initData() {
        ...
        speechUtil = new SpeechUtil(ReadActivity.this);
        toolbar.setTitle("");
...
//        initialTts();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add_bookmark){
            ...
            speechUtil.speak(pageFactory.getCurrentPage().getLineToString());
//            initialTts();
//            if (mSpeechSynthesizer != null){
...
//
//                mSpeechSynthesizer.speak("小说阅读有");
//                if (result < 0) {
...
//                + AppContext.LICENSE_FILE_NAME);
        ...
        this.mSpeechSynthesizer.setAppId("11482237"/*这里只是为了让Demo运行使用的APPID,请替换成自己的id。*/);
        // 请替换为语音开发者平台注册应用得到的apikey和secretkey (在线授权)
        this.mSpeechSynthesizer.setApiKey("KZtq7oEnSB1QSK1nYmcVlXNW",
                "kqtNFlHumnXLctOwGHZXmCzVykcTfscb "/*这里只是为了让Demo正常运行使用APIKey,请替换成自己的APIKey*/);
